...
// --- Fetch student stats ---
$totalAssessments = (int)$pdo->prepare("SELECT COUNT(*) FROM career_assessments WHERE user_id = ?");
$totalAssessments->execute([$userId]);
$totalAssessments = $totalAssessments->fetchColumn();
